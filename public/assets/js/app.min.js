    ...
    t.prototype.initFormValidation = function () {
        e(".needs-validation")
            .on("submit", function (t) {
                ...
                !1 !== e(this)[0].checkValidity() || (t.preventDefault(), t.stopPropagation(), !1)
            })
    },
...
function (n) {
    ...
    t.prototype.initMenu = function () {
        ...
        n(".button-menu-mobile").on("click", function (t) {
            ...
            "topnav" === e
                ...
                : (e.$body.toggleClass("sidebar-enable"), 768 <= e.$window.width()
                    ? e.$body.toggleClass("left-side-menu-condensed")
                    : e.$body.removeClass("left-side-menu-condensed"), e._resetSidebarScroll())
        });
        var t = e
            .$body
            .data("layout");
                ...
                var i = new MetisMenu("#menu-bar").on("shown.metisMenu", function (n) {
                    window
                        .addEventListener("click", function t(e) {
                            n
                                .target
                                .contains(e.target) || (i.hide(n.detail.shownElement), window.removeEventListener("click", t))
                        })
                });
                n("#menu-bar a").each(function () {
                    var t = window
        ...
        n(document).on("click", "body", function (t) {
            0 < n(t.target)
                .closest(".right-bar-toggle, .right-bar")
                .length || 0 < n(t.target)
                .closest(".left-side-menu, .side-nav")
                .length || n(t.target).hasClass("button-menu-mobile") || 0 < n(t.target)
                .closest(".button-menu-mobile")
                .length || (n("body").removeClass("right-bar-enabled"), n("body").removeClass("sidebar-enable"))
        }),
    ...
    t.prototype.initLayout = function () {
        768 <= this
            ...
            ? this
                .$body
                .addClass("left-side-menu-condensed")
            : 1 != this
                .$body
                .data("left-keep-condensed") && this
                .$body
                .removeClass("left-side-menu-condensed"),
        this
            .$body
            .hasClass("scrollable-layout") && n("#sidebar-menu").removeClass("slimscroll-menu")
    },
    t.prototype.init = function () {
        var e = this;
        this.initLayout(),
